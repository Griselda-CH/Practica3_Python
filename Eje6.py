...
la mediana y la moda de la lista. La media es el promedio de los números,
la mediana es el valor que separa la mitad superior de la inferior cuando la lista está ordenada,
y la moda es el número que más veces aparece en la lista.
